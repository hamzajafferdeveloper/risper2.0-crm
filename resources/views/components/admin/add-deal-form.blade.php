<form id="addDealForm" class="row g-3 max-h-[90vh] flex flex-col gap-3 overflow-y-auto px-5">
    @csrf
    <!-- Title -->
    <h2 class="text-2xl font-semibold text-gray-800">Add Deal Information</h2>
    ...
    <div class="flex flex-col gap-3 border-t pt-6">
        ...
        <div class="sm:flex gap-3">
            ...
            <div class="w-full sm:w-1/3">
                ...
                <select name="deal_watcher_id" class="form-select select2">
                    <option value="">Select</option>
