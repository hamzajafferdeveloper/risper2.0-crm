        ...
        <div class="col-auto">
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button data-dropdown-toggle="dropdownProfile" class="flex justify-center items-center rounded-full"
                    type="button">
                    <div id="avatar" class="avatar h-10 w-10 rounded-full text-black dark:text-white flex justify-center items-center bg-neutral-200 dark:bg-neutral-700"></div>
                </button>
                    ...
                    <div
                        class="py-3 px-4 rounded-lg bg-primary-50 dark:bg-primary-600/25 mb-4 flex items-center justify-between gap-2">
                            <h6 class="text-lg text-neutral-900 font-semibold mb-0">
                                {{ Auth::guard('web')->check() ? Auth::guard('web')->user()->name : (Auth::guard('employee')->check() ? Auth::guard('employee')->user()->name : 'Guest') }}
                            </h6>
                    </div>
...
@push('scripts')
    <script>
        ...
        function getAvatarInitials(name) {
         ...
         document.getElementById("avatar").textContent = getAvatarInitials(userName);
    </script>
@endpush
